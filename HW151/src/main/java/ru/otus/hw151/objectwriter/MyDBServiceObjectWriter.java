package ru.otus.hw151.objectwriter;


import ru.otus.hw151.base.*;
import ru.otus.hw151.cacheengine.SoftRefCacheEngine;
import ru.otus.hw151.executors.DataSetExecutor;
import ru.otus.hw151.executors.LogExecutor;
import ru.otus.hw151.handlers.TResultHandler;
import ru.otus.hw151.messagesystem.MessageSystemContext;
import ru.otus.hw151.messages.*;
...
public class MyDBServiceObjectWriter implements MyDBService {
    ...
    public MyDBServiceObjectWriter(MessageSystemContext context, Address address, SoftRefCacheEngine<DataSet> cacheEngine) {
    ...
    public <T extends DataSet> void save(T user) throws SQLException {
        ...
        MsgReceiveCacheStatusForAll msg = new MsgReceiveCacheStatusForAll(this.address,
                 context.getSocketServiceAddress(), cacheEngine.getHitMiss());
